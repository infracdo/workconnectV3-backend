...
public interface provider_circuits_today_repo
  ...
  @Query(value = "SELECT s.*, p.router, p.serial_number, p.loopback_0, p.loopback_1, p.loopback_2, p.loopback_0_24h, p.loopback_1_24h, p.loopback_2_24h FROM store_info_circuits s LEFT JOIN provider_circuits_today p ON s.site_id = p.site_id;", nativeQuery = true)
  List<Map<String, Object>> getCircuitLoops();
